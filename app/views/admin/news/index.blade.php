...
@section('content')
	...
	<div style="margin-bottom: 25px;"><a href="{{slink::to('admin/news/create')}}" class="btn btn-primary">Create</a></div>
					...
					<tbody>
						@foreach($news as $new)
							...
							<tr class="news-item">
								<td>{{$new->title}}</td>
								<td>{{$new->language}}</td>
								<td><a href="{{slink::to('admin/news/edit/'.$new->id)}}" class="btn btn-primary">Edit</a></td>
								<td>
									<form action="{{slink::to('admin/news/delete')}}" class="ajax_delete">
